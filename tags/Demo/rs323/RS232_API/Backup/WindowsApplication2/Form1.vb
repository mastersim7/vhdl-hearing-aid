Public Class Form1
    ...
    Public Sub UpdateTextBox()
        ...
        counter = counter + 1
        If counter = 1 Then
            c1 = SerialPort1.ReadExisting
        ElseIf counter = 2 Then
            c2 = SerialPort1.ReadExisting
            c3 = c1 & c2
            counter = 0
            strOut = Trim(HexString(c3))
    ...
    Private Sub Tx_Button_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Tx_Button.Click
        ...
        'sTx1 = TrackBar1.Value.ToString()
        'sTx2 = TrackBar2.Value.ToString()
        sTx1 = ChrW(TrackBar1.Value)
        sTx2 = ChrW(TrackBar2.Value)
        'sTx3 = ChrW(TrackBar1.Value)
        'sTx4 = ChrW(TrackBar1.Value)
        'sTx5 = ChrW(TrackBar1.Value)
        'sTx6 = ChrW(TrackBar1.Value)
        'sTx7 = ChrW(TrackBar1.Value)
        'sTx8 = ChrW(TrackBar1.Value)
