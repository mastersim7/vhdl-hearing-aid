...
FcB11=	100% First Cutoff Frequency
FcB12=	100+ ((1e4)/(2^7))% Second Cutoff Frequency
FcB2=   100+ ((1e4)/(2^6))
FcB3=   100+ ((1e4)/(2^5))
FcB4=   100+ ((1e4)/(2^4))
FcB5=   100+ ((1e4)/(2^3))
...
b{1}  = fir1(N, [FcB11 FcB12]/(Fs/2), 'bandpass', win, flag);
% tested a highpass b1  = fir1(N, 100/(Fs/2), 'high', win, flag);

Hd1 = dfilt.dffir(b{1});
b{2}  = fir1(N, [FcB12 FcB2]/(Fs/2), 'bandpass', win, flag);
Hd2 = dfilt.dffir(b{2});
b{3}  = fir1(N, [FcB2 FcB3]/(Fs/2), 'bandpass', win, flag);
Hd3 = dfilt.dffir(b{3});
b{4}  = fir1(N, [FcB3 FcB4]/(Fs/2), 'bandpass', win, flag);
Hd4 = dfilt.dffir(b{4});
b{5}  = fir1(N, [FcB4 FcB5]/(Fs/2), 'bandpass', win, flag);
Hd5 = dfilt.dffir(b{5});
...
Hd8 = dfilt.dffir(b{8});
Hd(9) = dfilt.dffir (b{1}+b{2}+b{3}+b{4}+b{5}+b{6}+b{7}+b{8}); %
